 ...
 (function() {
     ...
     var options = {
         ...
         imageIcons: [
             ...
             { value: 'assets/assumed.svg', icon: 'assets/assumed.svg' },
         ...
         arrowheadSize: [
             { value: 'M 0 0 0 0', content: 'None', icon:'assets/none.png' },
             { value: 'M 205.385 158.047 C 205.245 147.225 189.033 147.518 189.4 158.757 L 114.199 159.654 L 114.514 151.865 L 102.309 158.802 L 113.894 166.347 L 114.225 159.604 L 189.457 158.81 C 190.482 170.244 205.54 169.997 205.385 158.047 Z', content:'Asserted Inference/Evidence', icon: 'assets/assertedInference_evidence.png' },
             { value: 'M 173.008 214.92 L 173.008 210.1 L 90.699 210.1 L 90.669 209.364 L 173.008 209.364 L 173.008 204.85 L 183.888 204.85 L 183.888 214.92 L 173.008 214.92 Z', content: 'ACP identifier', icon: 'assets/acpIdentifier.png'},
             ...
             { value: 'M 330.002 286.776 C 329.027 281.525 319.903 281.942 319.34 287.677 L 240.62 287.891 L 240.832 287.965 L 319.287 287.69 C 319.624 296.276 330.186 294.388 330.055 288.155 C 330.048 287.817 330.098 287.405 330.021 287.038 L 330.002 286.776 Z', content: 'Circle',  icon: 'assets/circle.png'},
             { value: 'M 205.385 158.047 C 205.245 147.225 189.033 147.518 189.4 158.757 L 114.391 159.141 L 114.418 152.312 L 99.229 152.484 L 99.206 159.574 L 90.745 159.72 L 90.794 159.713 L 99.198 159.749 L 99.286 167.202 L 114.358 166.82 L 114.353 159.219 L 189.457 158.81 C 190.482 170.244 205.54 169.997 205.385 158.047 Z', content: 'Asserted Context', icon: 'assets/assertedContext.png'},
             { value: 'M 10 0 L 0 5 L 10 10 z', content: 'Normal', icon: 'assets/normal.png' },
            ],
